...
const elements = {
  filterSekect: document.getElementsByClassName('filter__dropdown'),
...
export function getInput() {
  ...
  if (elements.filterSekect[0].value !== 'all') {
    searchParams.append(elements.filterSekect[0].name, elements.filterSekect[0].value);
  }
